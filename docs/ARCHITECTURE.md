...
│   │   ├── conversational-flow-version.ts # Flow version types + validators
│   │   └── index.ts                       # Barrel export
│   │
│   ├── schemas/                  # OpenAPI schema and generated types
│   │   ├── generated/
│   │   │   └── index.ts          # Auto-generated by openapi-typescript
│   │   └── raw/                  # (deprecated - schema moved to api/)
│   │
